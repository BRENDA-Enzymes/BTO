 ...
 * [bto.yml](bto.yml)
     * Determines how your purl.obolibrary.org/obo/bto/ redirects will be handled
     ...
     * Paste in the contents of [bto.yml](bto.yml)
 ...
 * [bto.md](bto.md)
     ...
     * Paste in the contents of [bto.md](bto.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
