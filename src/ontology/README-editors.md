These notes are for the EDITORS of bto
...
Make sure you have an ID range in the [idranges file](bto-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [bto-edit.owl](bto-edit.owl)

** DO NOT EDIT bto.obo OR bto.owl in the top level directory **

[../../bto.owl](../../bto.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/BRENDA-Enzymes/BTO) for details.
 ...
 * [bto-idranges.owl](bto-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/bto_terms.txt file
...
Note: the bto_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as bto.owl and bto.obo and places
 ...
 * https://github.com/BRENDA-Enzymes/BTO/releases
 * https://github.com/BRENDA-Enzymes/BTO/releases/new
...
what is in the `owl:versionIRI` of the derived bto.owl (`data-version` in
bto.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/bto.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/bto/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/BRENDA-Enzymes/BTO.svg?branch=master)](https://travis-ci.org/BRENDA-Enzymes/BTO)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/BRENDA-Enzymes](https://travis-ci.org/profile/BRENDA-Enzymes)
 2. click the "Sync account" button
 3. Click the tick symbol next to BTO
